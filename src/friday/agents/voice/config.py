"""Настройки голосового агента из окружения/.env (префикс FRIDAY_VOICE_)."""
...
class VoiceSettings(BaseSettings):
    ...
    # --- Wake-word ---
    # Путь к обученной модели «Пятница» (.onnx/.tflite). Пусто → предобученные (НЕ «Пятница»).
    ...
    yandex_tts_voice: str = "alena"  # напр. alena, jane, omazh (жен) / filipp, ermil, zahar (муж)
