...
from christopher.agents.desktop.capabilities import REGISTRY, manifest_capabilities
...
from christopher.shared.protocol import CapabilityManifest, Command, Response, RiskLevel
from christopher.shared.topics import cmd_topic, registry_topic, resp_topic

log = logging.getLogger("christopher.desktop")
